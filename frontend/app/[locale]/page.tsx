...
export default function Home() {
  ...
  const popularTracks = [
    {
      ...
      icon: <Music className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "2",
      name: t("categories.art"),
      icon: <Palette className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "3",
      name: t("categories.coding"),
      icon: <Code2 className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "4",
      name: t("categories.dance"),
      icon: <Sparkles className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "5",
      name: t("categories.robotics"),
      icon: <Cpu className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "6",
      name: t("categories.photography"),
      icon: <Camera className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      id: "7",
      name: t("categories.writing"),
      icon: <PenTool className="w-7 h-7 text-[#FF7A45]" />,
    },
  ];
  ...
  const targets = [
    {
      title: t("target.students.title"),
      details: t("target.students.details"),
      icon: <GraduationCap className="w-9 h-9 text-[#FF7A45]" />,
    },
    {
      title: t("target.parents.title"),
      details: t("target.parents.details"),
      icon: <Users className="w-9 h-9 text-[#FF7A45]" />,
    },
    {
      title: t("target.teachers.title"),
      details: t("target.teachers.details"),
      icon: <UserCheck className="w-9 h-9 text-[#FF7A45]" />,
    },
    {
      title: t("target.schools.title"),
      details: t("target.schools.details"),
      icon: <Building2 className="w-9 h-9 text-[#FF7A45]" />,
    },
  ];
  ...
  const features = [
    {
      ...
      icon: <ClipboardList className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.live.title"),
      icon: <Video className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.progress.title"),
      icon: <BarChart2 className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.marketplace.title"),
      icon: <ShoppingBag className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.blog.title"),
      icon: <Newspaper className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.events.title"),
      icon: <Trophy className="w-7 h-7 text-[#FF7A45]" />,
    },
    {
      title: t("features.scholarships.title"),
      icon: <GraduationCap className="w-7 h-7 text-[#FF7A45]" />,
    },
  ];
  ...
  const testimonials = [
    {
      ...
      text: t("testimonials.mekdes.text"),
    },
    {
      name: "Samuel T.",
      role: t("testimonials.student"),
      text: t("testimonials.samuel.text"),
    },
    {
      name: "Mr. Tesfaye",
      role: t("testimonials.admin"),
      text: t("testimonials.tesfaye.text"),
    },
  ];
    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#1F2937] font-sans">
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <p className="text-base md:text-lg lg:text-[20px] text-[#6B7280] leading-relaxed mb-8 max-w-xl">
                {t("hero.subtitle")}
              </p>
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-2xl md:text-3xl lg:text-[40px] font-extrabold text-[#1F2937] tracking-tight">
              {t("categories.title")}
            </h2>
            <Link
              href="/hobbies"
              className="text-sm md:text-base font-bold text-[#FF7A45] hover:text-[#ff8f61] transition-colors"
            >
              {t("button.viewAll")}
            </Link>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-5">
            {popularTracks.map((track) => (
              <div
                key={track.id}
                className="w-[140px] h-[140px] flex-shrink-0 bg-white border border-gray-100 rounded-2xl p-4 flex flex-col items-center justify-center hover:translate-y-[-4px] hover:shadow-md transition-all duration-300 group cursor-pointer"
              >
                <div className="w-14 h-14 rounded-xl bg-[#FFF2EB] flex items-center justify-center text-[#FF7A45] mb-3 group-hover:scale-105 transition-transform duration-300">
                  {track.icon}
                </div>
                <h3 className="font-bold text-sm text-[#1F2937] text-center leading-snug">
                  {track.name}
                </h3>
              </div>
            ))}
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              <h2 className="text-2xl md:text-3xl lg:text-[44px] font-extrabold text-[#1F2937] tracking-tight mb-8">
                {t("howItWorks.title")}
              </h2>
              ...
              <div className="flex flex-col gap-8 w-full">
                {steps.map((step, index) => (
                  <div key={index} className="flex gap-5 items-start">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold text-[#1F2937] mb-1">
                        {step.title}
                      </h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14 text-center">
          <h2 className="text-2xl md:text-3xl lg:text-[40px] font-extrabold text-[#1F2937] tracking-tight mb-12">
            {t("whoIsFor.title")}
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {targets.map((target, index) => (
              <div
                key={index}
                className="bg-white border border-gray-100 rounded-[24px] p-8 flex flex-col items-center text-center hover:translate-y-[-6px] hover:shadow-xl transition-all duration-300 group cursor-default"
              >
                <div className="w-16 h-16 rounded-full bg-[#FFF2EB] flex items-center justify-center mb-6 group-hover:text-white transition-colors duration-300">
                  {target.icon}
                </div>
      ...
      <section className="py-20 bg-[#FAFAFA] border-y border-gray-100">
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-[40px] font-extrabold text-[#1F2937] tracking-tight mb-4">
              {t("platform.title")}
            </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-6 justify-center">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-5 border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col items-center text-center group"
              >
                <div className="w-16 h-16 rounded-2xl bg-[#FFF2EB] text-[#FF7A45] flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300">
                  {feature.icon}
                </div>
                <h3 className="text-sm md:text-base font-bold text-[#1F2937] leading-tight">
                  {feature.title}
                </h3>
              </div>
            ))}
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {testimonials.map((item, index) => (
              <div
                key={index}
                className="bg-white border border-gray-100 rounded-[24px] p-8 flex flex-col justify-between transition-all duration-300 hover:shadow-lg"
                style={{ height: "260px" }}
              >
                <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-[#1F2937] text-sm md:text-base">
                      {item.name}
                    </h4>
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-[#9CA3AF]">
              © {new Date().getFullYear()} HobbyHub Education.{" "}
              {t("footer.rights")}
            </p>
          </div>
        </div>
