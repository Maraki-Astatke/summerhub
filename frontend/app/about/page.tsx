      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <span className="text-xs font-bold text-[#FF7A45] tracking-wider uppercase mb-2 block">Our Core Pillars</span>
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#1F2937] tracking-tight mb-6">
                Why HobbyHub Education?
              </h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#1F2937] mb-1">Targeted Career Paths</h3>
                    <p className="text-sm text-[#6B7280] leading-relaxed">Curriculums mapped explicitly to global digital skill demands, tailored to the regional landscape.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#1F2937] mb-1">Interactive Community</h3>
                    <p className="text-sm text-[#6B7280] leading-relaxed">Collaborate with peers, compete in events, and join live online meetups with seasoned mentors.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#1F2937] mb-1">Verified Credentials</h3>
                    <p className="text-sm text-[#6B7280] leading-relaxed">Get recognized certification tokens that stand out in your professional profile and portfolio showcase.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FAFAFA] rounded-[32px] p-8 md:p-10 border border-gray-100 flex flex-col justify-center">
              ...
              <div className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-200/60">
                <div>
                  ...
                  <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Ethiopian Led</span>
                </div>
                <div>
                  <span className="text-3xl font-extrabold text-[#1F2937] block">6-Week</span>
                  <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Fast-Pace Tracks</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#FAFAFA] border-t border-gray-100">
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14 text-center max-w-2xl">
          ...
          <p className="text-sm text-[#6B7280] mb-8">
            Explore live classes, build high-value skill portfolios, and get certified.
          </p>
          <Link href="/register">
