...
export const getAdminQuizQuestions = async (req: any, res: any) => {
try {
...
export const getAdminQuizresponsesStudentStudentId = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
  return res.status(400).json({ errors: errors.array() });
}
...
export const getAdminQuizresponses = async (req: any, res: any) => {
try {
...
export const postAdminQuizresponsesStudentIdRecommend = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
  return res.status(400).json({ errors: errors.array() });
}
...
export const getAdminHobbieslist = async (req: any, res: any) => {
try {
...
export const getAdminQuizsummary = async (req: any, res: any) => {
try {
...
export const deleteAdminRecommendationsRecommendationId = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
  return res.status(400).json({ errors: errors.array() });
}
