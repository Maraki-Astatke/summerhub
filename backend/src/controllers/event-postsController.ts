...
export const getEventposts = async (req: any, res: any) => {
try {
...
export const getEventpostsId = async (req: any, res: any) => {
...
export const postEventpostsIdLike = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
return res.status(400).json({ errors: errors.array() });
}
...
export const postEventpostsIdComments = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
return res.status(400).json({ errors: errors.array() });
}
...
export const deleteEventpostsIdCommentsCommentId = async (req: any, res: any) => {
const postId = parseInt(req.params.id);
...
export const getAdminEventposts = async (req: any, res: any) => {
...
export const postAdminEventposts = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
return res.status(400).json({ errors: errors.array() });
}
...
export const putAdminEventpostsId = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
return res.status(400).json({ errors: errors.array() });
}
...
export const deleteAdminEventpostsId = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
return res.status(400).json({ errors: errors.array() });
}
...
export const getEventpostsId2 = async (req: any, res: any) => {
const errors = validationResult(req);
...
export const postEventpostsIdRegister = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) return res.status(400).json({ errors: errors.array() });
...
export const getAdminEventpostsIdRegistrations = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) return res.status(400).json({ errors: errors.array() });
const postId = parseInt(req.params.id);
try {
...
export const deleteAdminEventpostsRegistrationsRegId = async (req: any, res: any) => {
...
export const patchAdminEventpostsIdToggleregistration = async (req: any, res: any) => {
const postId = parseInt(req.params.id);
try {
const post = await prisma.eventPost.findUnique({ where: { id: postId } });
...
export const getEventpostsIdMyregistration = async (req: any, res: any) => {
const postId = parseInt(req.params.id);
const userId = req.user.userId;
try {
...
export const deleteEventpostsIdMyregistration = async (req: any, res: any) => {
const postId = parseInt(req.params.id);
const userId = req.user.userId;
try {
const registration = await prisma.talentEventRegistration.findFirst({
