...
export const debugStudentCertificates = async (req: any, res: any) => {
    try {
        ...
        res.json({
            debug: {
                ...
                allAICerts: allAICerts.map((c: any) => ({
                    id: c.id,
                ...
                aiCertsByEmail: aiCertsByEmail.map((c: any) => ({
                    id: c.id,
                    studentId: c.studentId,
                    studentEmail: c.studentEmail,
                    studentName: c.studentName,
                ...
                studentAICerts: aiCerts.map((c: any) => ({
                    id: c.id,
                    studentId: c.studentId,
                    studentEmail: c.studentEmail,
                    hobbyName: c.hobbyName
...
export const getAdminStudents = async (req: any, res: any) => {
    try {
...
export const issueCertificate = async (req: any, res: any) => {
    try {
...
export const getAllCertificates = async (req: any, res: any) => {
    try {
...
export const getMyCertificates = async (req: any, res: any) => {
    try {
        const studentId = Number(req.user.userId);
...
export const getCertificateById = async (req: any, res: any) => {
    try {
        const { id } = req.params;
...
export const downloadCertificate = async (req: any, res: any) => {
    try {
        const { id } = req.params;
        const studentId = Number(req.user.userId);
