...
export const getResourcesTeacherLessons = async (req: any, res: any) => {
try {
...
export const getResourcesLessonLessonIdStudents = async (req: any, res: any) => {
try {
...
export const postResourcesShare = async (req: any, res: any) => {
...
export const getResourcesStudent = async (req: any, res: any) => {
try {
...
export const getResourcesTeacherSent = async (req: any, res: any) => {
try {
  const teacherId = req.user.userId;
...
export const getResourcesTeacherSubmissions = async (req: any, res: any) => {
try {
  const teacherId = req.user.userId;
...
export const postResourcesSubmit = async (req: any, res: any) => {
const errors = validationResult(req);
if (!errors.isEmpty()) {
  return res.status(400).json({ errors: errors.array() });
}
...
export const putResourcesIdRead = async (req: any, res: any) => {
try {
  const { id } = req.params;
...
export const getResourcesIdDownload = async (req: any, res: any) => {
try {
  const { id } = req.params;
...
export const deleteResourcesId = async (req: any, res: any) => {
try {
  const { id } = req.params;
  const userId = req.user.userId;
