...
router.get('/scholarships/:id',
  [param('id').isInt()], getScholarshipsId
);

router.put('/scholarships/:id',
  authenticateToken,
  requireRole(['scholarship_giver', 'admin']),
  [param('id').isInt()], putScholarshipsId
);

router.delete('/scholarships/:id',
  authenticateToken,
  requireRole(['scholarship_giver', 'admin']),
  [param('id').isInt()], deleteScholarshipsId
);
...
router.get('/scholarships/applications',
  authenticateToken,
  requireRole(['scholarship_giver', 'admin']), getScholarshipsApplications
);
...
router.get('/my-applications',
  authenticateToken,
  requireRole(['student']), getMyapplications
);
