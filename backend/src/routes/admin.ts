...
router.get('/admin/users/:id',
  [param('id').isInt()], getAdminUsersId
);

router.put('/admin/users/:id/roles',
  [param('id').isInt(), body('roleIds').isArray()], putAdminUsersIdRoles
);

router.put('/admin/users/:id/activate',
  [param('id').isInt()], putAdminUsersIdActivate
);

router.put('/admin/users/:id/deactivate',
  [param('id').isInt()], putAdminUsersIdDeactivate
);

router.delete('/admin/users/:id',
  [param('id').isInt()], deleteAdminUsersId
);
