...
router.delete('/admin/quiz/questions/:id',
  authenticateToken,
  requireRole(['admin', 'teacher']), deleteAdminQuizQuestionsId
);
...
router.get('/quiz/results',
  authenticateToken,
  requireRole(['student']), getQuizResults
);

router.get('/quiz/recommendations',
  authenticateToken,
  requireRole(['student']), getQuizRecommendations
);

router.get('/quiz/progress',
  authenticateToken,
  requireRole(['student']), getQuizProgress
);
