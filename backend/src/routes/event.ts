...
router.get('/events/:id',
  [param('id').isInt()], getEventsId
);

router.put('/events/:id',
  authenticateToken,
  requireRole(['admin']),
  [param('id').isInt()], putEventsId
);

router.delete('/events/:id',
  authenticateToken,
  requireRole(['admin']),
  [param('id').isInt()], deleteEventsId
);
...
router.post('/events/:id/register',
  ...
  eventLimiter,
  [param('id').isInt()], postEventsIdRegister
);

router.delete('/events/:id/unregister',
  authenticateToken,
  requireRole(['student', 'scholar']),
  [param('id').isInt()], deleteEventsIdUnregister
);

router.post('/events/:id/submit-performance',
  authenticateToken,
  requireRole(['student', 'scholar']),
  [
    param('id').isInt(),
...
router.get('/my-events',
  authenticateToken,
  requireRole(['student', 'scholar']), getMyevents
);
