...
export const getHobbiesId = async (req, res) => {
    const { id } = req.params;
...
export const getHobbiesIdIsregistered = async (req, res) => {
    try {
        const { id } = req.params;
...
export const postHobbiesIdRegister = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.userId;
        const user = await prisma.user.findUnique({
...
export const deleteHobbiesIdUnregister = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.userId;
        const user = await prisma.user.findUnique({
...
export const getCategoriesCategoryIdHobbies = async (req, res) => {
