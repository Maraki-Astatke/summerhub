...
export const postTeacherLessonsCreate = async (req, res) => {
...
export const getTeacherStudentsStudentId = async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
export const getTeacherLessonsUpcoming = async (req, res) => {
    const teacherId = req.user.userId;
    const lessons = await prisma.lesson.findMany({
        where: {
            teacherId,
...
export const postTeacherLessonsIdCancel = async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
export const postTeacherCertificatesUpload = async (req, res) => {
    try {
        if (!req.file) {
...
export const postTeacherCertificatesIssue = async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
export const getTeacherCertificatesIssued = async (req, res) => {
    try {
        const teacherId = req.user.userId;
...
export const getStudentsCertificates = async (req, res) => {
    try {
...
export const getCertificatesIdDownload = async (req, res) => {
    try {
        const { id } = req.params;
