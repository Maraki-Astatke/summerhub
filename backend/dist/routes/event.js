...
router.get('/events/:id', [param('id').isInt()], async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
router.put('/events/:id', authenticateToken, requireRole(['admin']), [param('id').isInt()], async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
router.delete('/events/:id', authenticateToken, requireRole(['admin']), [param('id').isInt()], async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
router.post('/events/:id/register', authenticateToken, requireRole(['student', 'scholar']), eventLimiter, [param('id').isInt()], async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
router.delete('/events/:id/unregister', authenticateToken, requireRole(['student', 'scholar']), [param('id').isInt()], async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
router.get('/my-events', authenticateToken, requireRole(['student', 'scholar']), async (req, res) => {
    const userId = req.user.userId;
