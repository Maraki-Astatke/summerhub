...
const router = Router();
router.get('/seller/stats', authenticateToken, requireRole(['seller', 'admin']), async (req, res) => {
...
router.get('/seller/products', authenticateToken, requireRole(['seller', 'admin']), async (req, res) => {
    const sellerId = req.user.userId;
...
router.get('/seller/orders', authenticateToken, requireRole(['seller', 'admin']), async (req, res) => {
    const sellerId = req.user.userId;
...
router.put('/seller/orders/:orderId/fulfill', authenticateToken, requireRole(['seller', 'admin']), [param('orderId').isInt()], async (req, res) => {
...
router.get('/seller/inventory/alerts', authenticateToken, requireRole(['seller', 'admin']), async (req, res) => {
    const sellerId = req.user.userId;
