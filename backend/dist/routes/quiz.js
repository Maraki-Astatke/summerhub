...
router.delete('/admin/quiz/questions/:id', authenticateToken, requireRole(['admin', 'teacher']), async (req, res) => {
    const { id } = req.params;
...
router.get('/quiz/results', authenticateToken, requireRole(['student']), async (req, res) => {
    const studentId = req.user.userId;
...
router.get('/quiz/recommendations', authenticateToken, requireRole(['student']), async (req, res) => {
    const studentId = req.user.userId;
...
router.get('/quiz/progress', authenticateToken, requireRole(['student']), async (req, res) => {
    const studentId = req.user.userId;
