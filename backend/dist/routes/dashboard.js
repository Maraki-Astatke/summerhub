...
const router = Router();
router.get('/dashboard/stats', authenticateToken, requireRole(['student', 'scholar']), async (req, res) => {
...
router.get('/dashboard/progress', authenticateToken, requireRole(['student', 'scholar']), async (req, res) => {
    const userId = req.user.userId;
...
router.get('/dashboard/certificates', authenticateToken, requireRole(['student', 'scholar']), async (req, res) => {
    try {
...
router.get('/dashboard/achievements', authenticateToken, requireRole(['student', 'scholar']), async (req, res) => {
    const userId = req.user.userId;
