...
router.get('/resources/teacher/lessons', authenticateToken, requireRole(['teacher']), async (req, res) => {
    try {
...
router.get('/resources/lesson/:lessonId/students', authenticateToken, requireRole(['teacher']), async (req, res) => {
    try {
...
router.get('/resources/student', authenticateToken, requireRole(['student']), async (req, res) => {
    try {
...
router.get('/resources/teacher/sent', authenticateToken, requireRole(['teacher']), async (req, res) => {
    try {
        const teacherId = req.user.userId;
        const resources = await prisma.resource.findMany({
            where: {
...
router.get('/resources/teacher/submissions', authenticateToken, requireRole(['teacher']), async (req, res) => {
    try {
        const teacherId = req.user.userId;
...
router.put('/resources/:id/read', authenticateToken, async (req, res) => {
    try {
        const { id } = req.params;
