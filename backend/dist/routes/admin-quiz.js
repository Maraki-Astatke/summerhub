...
const router = Router();
router.get('/admin/quiz/questions', authenticateToken, requireRole(['admin']), async (req, res) => {
    try {
...
router.get('/admin/quiz-responses', authenticateToken, requireRole(['admin']), async (req, res) => {
    try {
...
router.get('/admin/hobbies-list', authenticateToken, requireRole(['admin']), async (req, res) => {
    try {
...
router.get('/admin/quiz-summary', authenticateToken, requireRole(['admin']), async (req, res) => {
    try {
